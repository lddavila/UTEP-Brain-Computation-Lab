function isoflureneSigmoidAnalysis
...
query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM isoflurenereactiontimepsychometricfunctions;";
reactionTimeResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM isoflurenerewardchoicepsychometricfunctions;";
rewardChoiceResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM isoflurenerotationpointspsychometricfunctions;";
rotationPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM isoflurenestoppingptspsychometricfunctions;";
stoppingPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM isoflurenetravelpixelpsychometricfunctions;";
