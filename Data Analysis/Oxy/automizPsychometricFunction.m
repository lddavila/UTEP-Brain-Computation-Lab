function automizPsychometricFunction
    function [T] = createMap()
        query = "SELECT referencetime, subjectid, mazenumber FROM live_table WHERE LOWER(health) LIKE '%oxy%' " + ...
            "OR LOWER(health) LIKE '%incubation%' " + ...
            "OR LOWER(health) LIKE '%craving%';";
...
% travelPixelLoop(T,"oxy_travelPixelPsychometricFunctions")
% %new travel pixel column: distanceaftertoneuntillimitingtimestamp
% 
% stoppingPointsLoop(T,"oxy_stoppingPointsPsychometricFunctions")
...
% 
% 
% rotationPointsLoop(T,"oxy_rotationPointsPsychometricFunctions")
% %mew rotation points column: rotationptsmethod1

rewardChoiceLoop(T,"oxy_rewardChoicePsychometricFunctions")
end