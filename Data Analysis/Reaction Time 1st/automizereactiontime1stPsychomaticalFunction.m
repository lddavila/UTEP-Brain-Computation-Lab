function automizereactiontime1stPsychomaticalFunction
    ...
    function [ycoordinates] = createPsychomaticalFunction(searchResults)
        local = searchResults;
        ...
        while i <= numberOfTotalRows
            ...
            switch feederValue
                ...
                %FEATURE VALUES
                case '1'
                    feeder1Totals = feeder1Totals + str2double(string(local{i,19}));
                case '2'
                    feeder2Totals = feeder2Totals +str2double(string(local{i,19}));
                case '3'
                    feeder3Totals = feeder3Totals+str2double(string(local{i,19}));
                case '4'
                    feeder4Totals = feeder4Totals+str2double(string(local{i,19}));
            end
...
%                     disp(query)
                ...
                [ycoordinates] = createPsychomaticalFunction(searchResults2);
                ...
                sqlwrite(conn,"reactiontime1stPsychomaticalFunctions",data)
