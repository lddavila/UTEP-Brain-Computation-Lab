function automizeGhrelinPsychomaticalFunction
    function [T] = createMap()
        query = "SELECT referencetime, subjectid, mazenumber FROM live_table WHERE health LIKE '%Ghrelin%' OR health LIKE '%ghrelin%';";
            ...
            try
                ...
                while secondaryCounter < width(animalsOnThatDate)
                    ...
                    try
                        ...
                        sqlwrite(conn,"GhrelinRewardChoicePsychometricFunctions",data)
...
%                     display(theformattedDate)
                    ...
                    %uploads the psychomatical function to the "psychomaticalFunctions"
                    %table in the database
                    sqlwrite(conn,"ghrelinReactionTimePsychometricFunctions",data)
...
%                         counter = counter+1;
                    ...
                    %uploads the psychomatical function to the "psychomaticalFunctions"
                    %table in the database
                    sqlwrite(conn,"ghrelinRotationPointsPsychometricFunctions",data)
                    %                 disp("the following query was written to the travelpixeltable")
                    %                 disp(query)
                    secondaryCounter = secondaryCounter +1;
                catch ME
...
%                         end
                        ...
                        %uploads the psychomatical function to the "psychomaticalFunctions"
                        %table in the database
                        sqlwrite(conn,"ghrelinStoppingptsPsychometricFunctions",data)
                        %                 disp("the following query was written to the travelpixeltable")
                        %                 disp(query)
                        secondaryCounter = secondaryCounter +1;
%                     catch
            ...
            try
                ...
                while secondaryCounter <= width(animalsOnThatDate)
                    try
                        ...
                        %uploads the psychomatical function to the "psychomaticalFunctions"
                        %table in the database
                        sqlwrite(conn,"ghrelinTravelPixelPsychometricFunctions",data)
                        %                 disp("the following query was written to the travelpixeltable")
                        %                 disp(query)
                        secondaryCounter = secondaryCounter +1;
                    catch
