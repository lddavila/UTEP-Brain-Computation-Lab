function automizPsychometricFunction
    function [T] = createMap()
        query = "SELECT referencetime, subjectid, mazenumber FROM live_table WHERE genotype='lg_etoh';";
...
% reactionTimeLoop(T,"lg_etoh_reactionTimePsychometricFunctions")
%reaction time has been eliminated 

% travelPixelLoop(T,"lg_etoh_travelPixelPsychometricFunctions")
%new travel pixel column: distanceaftertoneuntillimitingtimestamp

% stoppingPointsLoop(T,"lg_etoh_stoppingPointsPsychometricFunctions")
%mew stopping points column: stoptimemethod6
%the valued in stoptimemethod6 must be mulitplied by 10 to get the actual
%number of stopping points


% rotationPointsLoop(T,"lg_etoh_rotationPointsPsychometricFunctions")
% %mew rotation points column: rotationptsmethod1

rewardChoiceLoop(T,"lg_etoh_rewardChoicePsychometricFunctions")
end