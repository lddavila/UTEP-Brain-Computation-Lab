...
%             display(gof3.rsquare)
            dynamicName = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Saline-Grahline-Alcohol-Food Deprivation Analysis\";
...
mkdir(strcat(dName,"Travel Pixel 2 Parameter Sigmoid"))
mkdir(strcat(dName,"Travel Pixel 3 Parameter Sigmoid"))
mkdir(strcat(dName,"Travel Pixel 4 Parameter Sigmoid"))
mkdir(strcat(dName,"Travel Pixel Sigmoid Data"))
mkdir(strcat(dName,"Travel Pixel Lines"))
mkdir(strcat(dName,"Travel Pixel Line Data"))
mkdir(strcat(dName,"Travel Pixel Parabolas"))
mkdir(strcat(dName,"Travel Pixel Parabola Data"))

mkdir(strcat(dName,"Stopping Points 2 Parameter Sigmoid"))
mkdir(strcat(dName,"Stopping Points 3 Parameter Sigmoid"))
mkdir(strcat(dName,"Stopping Points 4 Parameter Sigmoid"))
mkdir(strcat(dName,"Stopping Points Sigmoid Data"))
mkdir(strcat(dName,"Stopping Points Lines"))
mkdir(strcat(dName,"Stopping Points Line Data"))
mkdir(strcat(dName,"Stopping Points Parabolas"))
mkdir(strcat(dName,"Stopping Points Parabola Data"))



mkdir(strcat(dName,"Reaction Time 2 Parameter Sigmoid"))
mkdir(strcat(dName,"Reaction Time 3 Parameter Sigmoid"))
mkdir(strcat(dName,"Reaction Time 4 Parameter Sigmoid"))
mkdir(strcat(dName,"Reaction Time Sigmoid Data"))
mkdir(strcat(dName,"Reaction Time Lines"))
mkdir(strcat(dName,"Reaction Time Line Data"))
mkdir(strcat(dName,"Reaction Time Parabolas"))
mkdir(strcat(dName,"Reaction Time Parabola Data"))


mkdir(strcat(dName,"Reward Choice 2 Parameter Sigmoid"))
mkdir(strcat(dName,"Reward Choice 3 Parameter Sigmoid"))
mkdir(strcat(dName,"Reward Choice 4 Parameter Sigmoid"))
mkdir(strcat(dName,"Reward Choice Sigmoid Data"))
mkdir(strcat(dName,"Reward Choice Lines"))
mkdir(strcat(dName,"Reward Choice Line Data"))
mkdir(strcat(dName,"Reward Choice Parabolas"))
mkdir(strcat(dName,"Reward Choice Parabola Data"))


mkdir(strcat(dName,"Rotation Points 2 Parameter Sigmoid"))
mkdir(strcat(dName,"Rotation Points 3 Parameter Sigmoid"))
mkdir(strcat(dName,"Rotation Points 4 Parameter Sigmoid"))

mkdir(strcat(dName,"Rotation Points Sigmoid Data"))

mkdir(strcat(dName,"Rotation Points Line"))
mkdir(strcat(dName,"Rotation Points Line Data"))

mkdir(strcat(dName,"Rotation Points Parabola"))
mkdir(strcat(dName,"Rotation Points Parabola Data"))




query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM ghrelinreactiontimepsychometricfunctions;";
reactionTimeResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM ghrelinrewardchoicepsychometricfunctions;";
rewardChoiceResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM ghrelinrotationpointspsychomaticfunctions;";
rotationPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM ghrelinstoppingptspsychometricfunctions;";
stoppingPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM ghrelintravelpixelpsychometricfunctions;";
