...
%                     display(theformattedDate)
                    query = strcat("SELECT id,referencetime,subjectid,reactiontime1st FROM featuretable4 WHERE " + ...
...
%                     display(theDate)
                    theFormattedDate = formatTheDate(theDate);
                    %display(theformattedDate)
                    query = strcat("SELECT id,referencetime,subjectid,rotationpts FROM featuretable4 WHERE referencetime LIKE '",theFormattedDate,"%'"," AND subjectid = '", animalsOnThatDate{secondaryCounter},"';");
                    disp(animalsOnThatDate{secondaryCounter})
            ...
            try
                ...
                while secondaryCounter < width(animalsOnThatDate)
                    try
                        ...
                        theFormattedDate = formatTheDate(theDate);
                        display(theFormattedDate)
                        query = strcat("SELECT id,referencetime,subjectid,stoptimemethod2 FROM featuretable4 WHERE referencetime LIKE '",theFormattedDate,"%'"," AND subjectid = '", animalsOnThatDate{secondaryCounter},"';");
            ...
            try
                ...
                while secondaryCounter <= width(animalsOnThatDate)
                    try
                        ...
                        theFormattedDate = formatTheDate(theDate);
                        %display(theformattedDate)
                        query = strcat("SELECT id,referencetime,subjectid,distanceaftertoneuntillimitingtimestamp FROM featuretable4 WHERE referencetime LIKE '",theFormattedDate,"%'"," AND subjectid = '", animalsOnThatDate{secondaryCounter},"';");
