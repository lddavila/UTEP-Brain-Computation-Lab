...
query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM alcoholreactiontimepsychometricfunctions;";
...
query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM alcoholrotationpointspsychometricfunctions;";
rotationPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM alcoholstoppingptspsychometricfunctions;";
stoppingPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM alcoholtravelpixelpsychometricfunctions;";
