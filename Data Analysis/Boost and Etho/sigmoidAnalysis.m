...
query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM lg_etoh_travelPixelPsychometricFunctions;";
travelPixelResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM lg_etoh_stoppingPointsPsychometricFunctions;";
stoppingPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM lg_etoh_rotationPointsPsychometricFunctions;";
rotationPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM lg_etoh_rewardChoicePsychometricFunctions;";
