function rescueRotationPointsSigmoidAnalysis
...
%                 display(y.')
                ...
                dynamicName = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Rotation Points\";


                if gof3.rsquare >= .5
                    saveas(fighandle3,strcat(dynamicName,"Rotation Pts Rescued Sigmoid\",string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),".fig"))
                    save(strcat(dynamicName,'Rotation Pts Rescued Sigmoid Data\',string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),'.mat'),'fitobject3')
                    delete(strcat(dynamicName,"Rotation Pts Parabolas - Copy\",string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),".fig"))
    ...
    function[results] = createDataTable()
        ...
        ParabolaFilePath = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Rotation Points\Rotation Pts Parabola - Copy";
