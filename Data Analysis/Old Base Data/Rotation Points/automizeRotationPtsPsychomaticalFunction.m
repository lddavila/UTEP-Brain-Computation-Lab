function automizeRotationPtsPsychomaticalFunction
...
%             disp("NAN DETECTED")
        ...
        while i <= numberOfTotalRows
            ...
            switch feederValue
                ...
                %FEATURE VALUES
                case '1'
                    feeder1Totals = feeder1Totals + str2double(string(local{i,22}));
                case '2'
                    feeder2Totals = feeder2Totals +str2double(string(local{i,22}));
                case '3'
                    feeder3Totals = feeder3Totals+str2double(string(local{i,22}));
                case '4'
                    feeder4Totals = feeder4Totals+str2double(string(local{i,22}));
            end
...
%                     disp(query)
                ...
                sqlwrite(conn,"rotationPtsPsychomaticalFunctions",data)
