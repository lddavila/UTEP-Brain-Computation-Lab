function rescueReactionTime1stSigmoidAnalysis
...
%                 fighandle4 = gcf;
                ...
                dynamicName = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Reaction Time 1st\";


                if gof3.rsquare >= .5
                    saveas(fighandle3,strcat(dynamicName,"Reaction Time 1st Rescued Sigmoid\",string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),".fig"))
                    save(strcat(dynamicName,'Reaction Time 1st Rescued Sigmoid Data\',string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),'.mat'),'fitobject3')
                    delete(strcat(dynamicName,"Reaction Time 1st Parabolas - Copy\",string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),".fig"))
    ...
    function[results] = createDataTable()
        ...
        ParabolaFilePath = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Reaction Time 1st\Reaction Time 1st Parabolas - Copy";
