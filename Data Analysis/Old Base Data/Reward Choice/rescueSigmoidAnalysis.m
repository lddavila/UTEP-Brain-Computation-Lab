function rescueSigmoidAnalysis
...
%                 fighandle4 = gcf;
                ...
                dynamicName = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Reward Choice\";


                if gof3.rsquare >= .5
                    saveas(fighandle3,strcat(dynamicName,"Rescued Sigmoid\",string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),".fig"))
                    save(strcat(dynamicName,'Rescued Sigmoid Data\',string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),'.mat'),'fitobject3')
                    delete(strcat(dynamicName,"Parabolas - Copy\",string(results{i,1})," ", strrep(string(results{i,2}),"/","-"),".fig"))
    ...
    function[results] = createDataTable()
        ...
        ParabolaFilePath = "C:\Users\ldd77\OneDrive\Desktop\UTEP-Brain-Computation-Lab\Data Analysis\Reward Choice\Parabolas - Copy";
