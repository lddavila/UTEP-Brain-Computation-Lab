function preFeedingSigmoidAnalysis
...
query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM prefeedingreactiontimepsychometricfunctions;";
reactionTimeResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM prefeedingrewardchoicepsychometricfunctions;";
rewardChoiceResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM prefeedingrotationpointspsychometricfunctions;";
rotationPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM prefeedingstoppingptspsychometricfunctions;";
stoppingPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM prefeedingtravelpixelpsychometricfunctions;";
