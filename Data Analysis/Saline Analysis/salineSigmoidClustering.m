function salineSigmoidClustering
...
% travelPixelSigmoidTableSaline = getTable(strcat(currentFolder,"\Travel Pixel Sigmoid Data"));
...
% createMaxVsShiftPlot(travelPixelSigmoidTable,3,travelPixelSigmoidTableSaline,3,"Travel Pixel")
% figure
% createMaxVsSteepnessPlot(travelPixelSigmoidTable,3,travelPixelSigmoidTableSaline,2,"Travel Pixel")
% figure
% createShiftVsSteepnessPlot(travelPixelSigmoidTable,4,travelPixelSigmoidTableSaline,3,"Travel Pixel")
% 
% stoppingPointsSigmoidTableSaline = getTable(strcat(currentFolder,"\Stopping Points Sigmoid Data"));
...
% createMaxVsShiftPlot(stoppingPointsSigmoidTable,3,stoppingPointsSigmoidTableSaline,4,"Stopping Points")
% figure
% createMaxVsSteepnessPlot(stoppingPointsSigmoidTable,4,stoppingPointsSigmoidTableSaline,4,"Stopping Points")
% figure
% createShiftVsSteepnessPlot(stoppingPointsSigmoidTable,3,stoppingPointsSigmoidTableSaline,3,"Stopping Points")
% 
% rotationPointsSigmoidTableSaline = getTable(strcat(pwd,"\Rotation Points Sigmoid Data"));
...
% createMaxVsShiftPlot(rotationPointsSigmoidTable,4,rotationPointsSigmoidTableSaline,3,"Rotation Points")
% figure
% createMaxVsSteepnessPlot(rotationPointsSigmoidTable,4,rotationPointsSigmoidTableSaline,3,"Rotation Points")
% figure
% createShiftVsSteepnessPlot(rotationPointsSigmoidTable,3,rotationPointsSigmoidTableSaline,3,"Rotation Points")
% 
% 
...
% reactionTimeSigmoidTableSaline = getTable(strcat(pwd,"\Reaction Time Sigmoid Data"));
% createMaxVsShiftPlot(reactionTimeSigmoidTable,4,reactionTimeSigmoidTableSaline,3,"Reaction Time")
% figure
% createMaxVsSteepnessPlot(reactionTimeSigmoidTable,3,reactionTimeSigmoidTableSaline,3,"Reaction Time")
% figure
% createShiftVsSteepnessPlot(reactionTimeSigmoidTable,4,reactionTimeSigmoidTableSaline,3,"Reaction Time")
% 
% 
% rewardChoiceSigmoidTableSaline =getTable(strcat(pwd,"\Reward Choice Sigmoid Data"));
...
% createMaxVsShiftPlot(rewardChoiceSigmoidTable,4,rewardChoiceSigmoidTableSaline,3,"Reward Choice")
% figure
% createMaxVsSteepnessPlot(rewardChoiceSigmoidTable,3,rewardChoiceSigmoidTableSaline,2,"Reward Choice")
% figure
% createShiftVsSteepnessPlot(rewardChoiceSigmoidTable,3,rewardChoiceSigmoidTableSaline,2,"Reward Choice")
% 
end