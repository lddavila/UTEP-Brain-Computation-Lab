function salineSigmoidAnalysis
...
query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM salinereactiontimepsychometricfunctions;";
reactionTimeResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM salinerewardchoicepsychometricfunctions;";
rewardChoiceResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM salinerotationpointspsychometricfunctions;";
rotationPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM salinestoppingptspsychometricfunctions;";
stoppingPointsResults = fetch(conn,query);

query = "SELECT subjectid,date,x1,x2,x3,x4,y1,y2,y3,y4 FROM salinetravelpixelpsychometricfunctions;";
