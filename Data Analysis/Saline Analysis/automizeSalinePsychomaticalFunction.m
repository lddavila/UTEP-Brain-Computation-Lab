function automizeSalinePsychomaticalFunction
    function [T] = createMap()
        query = "SELECT referencetime, subjectid, mazenumber FROM live_table WHERE health LIKE '%Saline%' OR health LIKE '%saline%';";
            ...
            try
                ...
                while secondaryCounter < width(animalsOnThatDate)
                    ...
                    try
                        ...
                        sqlwrite(conn,"salineRewardChoicePsychometricFunctions",data)
...
%                     display(theformattedDate)
                    ...
                    %uploads the psychomatical function to the "psychomaticalFunctions"
                    %table in the database
                    sqlwrite(conn,"salineReactionTimePsychometricFunctions",data)
...
%                         counter = counter+1;
                    ...
                    %uploads the psychomatical function to the "psychomaticalFunctions"
                    %table in the database
                    sqlwrite(conn,"salineRotationPointsPsychometricFunctions",data)
                    %                 disp("the following query was written to the travelpixeltable")
                    %                 disp(query)
                    secondaryCounter = secondaryCounter +1;
                catch ME
            ...
            try
                ...
                while secondaryCounter < width(animalsOnThatDate)
                    try
                        ...
                        %uploads the psychomatical function to the "psychomaticalFunctions"
                        %table in the database
                        sqlwrite(conn,"salineStoppingptsPsychometricFunctions",data)
                        %                 disp("the following query was written to the travelpixeltable")
                        %                 disp(query)
                        secondaryCounter = secondaryCounter +1;
                    catch
            ...
            try
                ...
                while secondaryCounter <= width(animalsOnThatDate)
                    try
                        ...
                        %uploads the psychomatical function to the "psychomaticalFunctions"
                        %table in the database
                        sqlwrite(conn,"salineTravelPixelPsychometricFunctions",data)
                        %                 disp("the following query was written to the travelpixeltable")
                        %                 disp(query)
                        secondaryCounter = secondaryCounter +1;
                    catch
