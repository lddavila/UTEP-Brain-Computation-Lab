function automizeFoodDeprivationPsychomaticalFunction
    function [T] = createMap()
        query = "SELECT referencetime, subjectid, mazenumber FROM live_table WHERE LOWER(health) LIKE LOWER('%food deprivation%');";
            ...
            try
                ...
                while secondaryCounter < width(animalsOnThatDate)
                    ...
                    try
                        ...
                        sqlwrite(conn,"foodDeprivationRewardChoicePsychometricFunctions",data)
...
%                     display(theformattedDate)
                    ...
                    %uploads the psychomatical function to the "psychomaticalFunctions"
                    %table in the database
                    sqlwrite(conn,"foodDeprivationReactionTimePsychometricFunctions",data)
...
%                         counter = counter+1;
                    ...
                    %uploads the psychomatical function to the "psychomaticalFunctions"
                    %table in the database
                    sqlwrite(conn,"foodDeprivationRotationPointsPsychometricFunctions",data)
                    %                 disp("the following query was written to the travelpixeltable")
                    %                 disp(query)
                    secondaryCounter = secondaryCounter +1;
                catch ME
            ...
            try
                ...
                while secondaryCounter < width(animalsOnThatDate)
                    try
                        ...
                        %uploads the psychomatical function to the "psychomaticalFunctions"
                        %table in the database
                        sqlwrite(conn,"foodDeprivationStoppingptsPsychometricFunctions",data)
                        %                 disp("the following query was written to the travelpixeltable")
                        %                 disp(query)
                        secondaryCounter = secondaryCounter +1;
                    catch
            ...
            try
                ...
                while secondaryCounter <= width(animalsOnThatDate)
                    try
                        ...
                        %uploads the psychomatical function to the "psychomaticalFunctions"
                        %table in the database
                        sqlwrite(conn,"foodDeprivationTravelPixelPsychometricFunctions",data)
                        %                 disp("the following query was written to the travelpixeltable")
                        %                 disp(query)
                        secondaryCounter = secondaryCounter +1;
                    catch
