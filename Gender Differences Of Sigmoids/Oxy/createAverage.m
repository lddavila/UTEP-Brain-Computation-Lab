...
% AThree =plot(x,y3);
AFour = plot(x,y4);
legend([AOne,ATwo,AFour],["J1: 6 Females, 11 Males","J2: 50 Females, 55 Males","J4: 19 Females, 13 Males"])
title("Food Deprivation Reaction Time Max Vs Shift Average Sigmoids")